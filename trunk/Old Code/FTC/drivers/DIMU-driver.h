...
#define DIMU_GYRO_X_AXIS        0x00  /*!< X Axis for Gyro */
#define DIMU_GYRO_Y_AXIS        0x01  /*!< Y Axis for Gyro */
#define DIMU_GYRO_Z_AXIS        0x02  /*!< Z Axis for Gyro */
...
float DIMUreadGyroAxis(tSensors link, ubyte axis){
	...
	return (_lsb+((long)(_msb<<8)))/DIMU_Gyro_divisor;
}
...
bool DIMUconfigAccel(tSensors link, ubyte range) {
  switch(range) {
    case DIMU_ACC_RANGE_2G: DIMU_Gyro_divisor[link] = 16.0; break;
    case DIMU_ACC_RANGE_4G: DIMU_Gyro_divisor[link] = 32.0; break;
    case DIMU_ACC_RANGE_8G: DIMU_Gyro_divisor[link] = 64.0; break;
  }
...
float DIMUreadAccelAxis8Bit(tSensors link, ubyte axis){
  int sensorReading = 0;
	...
	return ((sensorReading > 128) ? sensorReading - 256 : sensorReading) / DIMU_Gyro_divisor[link];
}
