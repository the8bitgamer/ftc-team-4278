...
task main()
{
  ...
  while(SensorValue[rollingDetector] < 40/* || nMotorEncoder[motorsRight] < 3439*/)
  {
    motor[motorsLeft] = 10;
  ...
  // </lift and lower>
  //int encVal = forward(1.41, wR);
  //while(nMotorEncoder[motorsLeft] > encVal)
  //{
  //  motor[motorsLeft] = -10;
  //  motor[motorsRight] = -10;
  //}

  makeRight(.5, 10, wR, dBW);
