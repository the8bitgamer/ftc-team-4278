...
#pragma config(Motor,  mtr_S1_C1_1,     motorArm1,     tmotorNormal, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C1_2,     motorArm2,     tmotorNormal, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C2_1,     motorArm3,     tmotorNormal, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C2_2,     motorArmBind,  tmotorNormal, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C3_1,     motorArmTurn,  tmotorNormal, openLoop, encoder)
#pragma config(Motor,  mtr_S1_C3_2,     motorI,        tmotorNone, openLoop) 42
...
//   To do for functionality:
//   1: Change pragmas to match motor reversal
//   2: Change gear ratios to match reality
//   3: Set max, min, norm speeds
//   4: Set target angles
void liftArm()
{
  //Define variable target angles and motor stop bools
  ...
  while(!stopArm1 || !stopArm2 || !stopArm3 || !stopArmTurn)
  {
    ...
    float pctComplete1 = (angleVal1 / targetAngle1);
    float pctComplete2 = (angleVal2 / targetAngle2);
    float pctComplete3 = (angleVal3 / targetAngle3);
    float pctCompleteTurn = (angleValTurn / targetAngleTurn);
