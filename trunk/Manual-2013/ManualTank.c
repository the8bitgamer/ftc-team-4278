...
task main() {
	...
	while(true) {
		...
		nxtDisplayTextLine(3, "x1:%i", joystick.joy1_x1);
		nxtDisplayTextLine(4, "x2:%i", joystick.joy1_x2);
		nxtDisplayTextLine(5, "y1:%i", joystick.joy1_y1);
		nxtDisplayTextLine(6, "y2:%i", joystick.joy1_y2);
